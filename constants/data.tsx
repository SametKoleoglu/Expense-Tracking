...
export const accountOptions: accountOptionType[] = [
  {
    title: "Edit Profile",
    icon: <Icons.User size={23} color={colors.neutral200} weight="fill" />,
    routeName: "/(modals)/profileModal",
    bgColor: "#6366f1",
  },
  {
    title: "Settings",
    icon: <Icons.GearSix size={23} color={colors.neutral200} weight="fill" />,
    // routeName: "/(modals)/profileModal",
    bgColor: "#059669",
  },
  {
    title: "Privacy Policy",
    icon: <Icons.Lock size={23} color={colors.neutral200} weight="fill" />,
    // routeName: "/(modals)/profileModal",
    bgColor: colors.neutral600,
  },
  {
    title: "Sign Out",
    icon: <Icons.Power size={23} color={colors.neutral200} weight="fill" />,
    routeName: "/(modals)/profileModal",
    bgColor: "#e11d48",
  },
];
